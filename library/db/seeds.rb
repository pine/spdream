...
Book.create :title => '802.00無線ネットワーク管理', :auther => 'Matthew Gast', :outline => '規格書を併読しなくても802.11プロトコルを理解できる「IEEEの規格書いらず」の実践ガイド。規格書の仕様に縛られずにプロトコルの全体的な動きや内容を解説します。', :isbn10 => 4873113083, :isbn13 => 0, :opac_id => 6, :value => 4, :category_id => 1, :child_category_id => 4, :request => true, :tag0 => 'レポート'
...
Book.create :title => 'TCP/IP', :auther => 'Craig Hunt', :outline => '本書はネットワーク管理者のバイブルとして知られるTCP/IP解説書の完全改訂版です。TCP/IPの基礎、ネットワークの設計、Unixカーネルの設定、経路制御、各種サーバやsendmailの設定などについて、詳細かつ「実用的」な情報を提供します。', :isbn10 => 4873111293, :isbn13 => 0, :opac_id => 894, :value => 4, :category_id => 1, :child_category_id => 4, :request => true, :tag0 => 'レポート', :tag1 => 'TCP/IP'
Book.create :title => 'はじめてのRuby on Rails', :auther => '清水美樹', :outline => '本書は、筆者が初めて「Ruby on Rails」と付き合っていた過程をそのまま本にしたものです。', :isbn10 => 4777512320, :isbn13 => 0, :opac_id => 84, :value => 2, :category_id => 1, :child_category_id => 1, :request => true, :tag0 => 'プログラミング', :tag1 => 'Ruby on Rails'
Book.create :title => 'かんたんRuby on RailsでWebアプリケーション開発', :auther => 'arton', :outline => '本書は手で覚えることを主眼としたRuby on Railsの入門書です。説明は必要最低限のものに抑えてあります。まずは実際にプログラムを打ち込んで、動かして、そして実際の動きを確認してください。', :isbn10 => 4798111570, :isbn13 => 0, :opac_id => 465, :value => 3, :category_id => 1, :child_category_id => 1, :request => true, :tag0 => 'プログラミング', :tag1 => 'Ruby on Rails'
Book.create :title => 'Ruby on Rails入門　優しいRailsの育て方', :auther => '西和則', :outline => 'オブジェクト指向の基本からWebアプリケーションの作り方、プラグインからテスト、改造までぎっしり詰め込んで、Rubyはよく知らない人もRubyだけでRailsは使ってない人も、既にRailsを使っている人も誰でも安心。', :isbn10 => 4798013951, :isbn13 => 0, :opac_id => 84, :value => 4, :category_id => 1, :child_category_id => 1, :request => true, :tag0 => 'プログラミング', :tag1 => 'Ruby on Rails'
Book.create :title => 'マスタリングTCP/IP入門編第5版', :auther => '竹下隆史・村上公保・荒井透・苅田幸雄', :outline => '本書によって読者の方々が、TCP/IPとコンピュータネットワークをマスターするための足がかりを得るとともに、その全体像を把握していただければと思っています。', :isbn10 => 0, :isbn13 => 9784274068768, :opac_id => 48, :value => 5, :category_id => 1, :child_category_id => 4, :request => true, :tag0 => 'レポート', :tag1 => 'TCP/IP'
...
Book.create :title => '面接　自己PR・志望動機 完全版', :auther => '坂本直文', :outline => '本書は、著者が就職指導を行ってきた内定者の協力をもとに作成されています。', :isbn10 => 0, :isbn13 => 97844471706234, :opac_id => 874, :value => 3, :category_id => 5, :child_category_id => 1, :request => true, :tag0 => '面接'
Book.create :title => '全解SPI実戦問題集', :auther => '高橋書店', :outline => '実際のSPI試験に沿った形式で、豊富に問題を載せ、丁寧でわかりやすい解説がしてあります。', :isbn10 => 447164640, :isbn13 => 0, :opac_id => 968, :value => 3, :category_id => 5, :child_category_id => 1, :request => true, :tag0 => 'SPI'
...
Book.create :title => '脳を活かす伝え方、聞き方', :auther => '茂木健一郎', :outline => 'なぜ会話をすると脳にいいのか、本書ではコミュニケーションベタを克服した著者の豊富な実例とエピソードで学べる一冊。 ', :isbn10 => 0, :isbn13 => 9784569816692, :opac_id => 98, :value => 3, :category_id => 6, :child_category_id => 5, :request => true, :tag0 => ''
...
Book.create :title => '心は前をむいている', :auther => '串崎真志', :outline => '三か月児から大人までを対象とした多くの心理学実験が、人の心の基本設計をどう描きだしているのだろうか。信頼、想像、錯覚、がまん、疲労、悲しみなどのキーワードごとに、実験を通して心の向き方を解説していきます。後ろ向きになりやすく、ネガティブな感情にも役立つ機能があることから、前を向くための秘訣は? ', :isbn10 => 4005007627, :isbn13 => 0, :opac_id => 2461, :value => 2, :category_id => 6, :child_category_id => 5, :request => true, :tag0 => ''
